...
Se han realizados estudios en piel de mamíferos contribuyendo a su caracterización y análisis, sin embargo las técnicas disponibles no son capaces de identificar de forma general a las CL en todos los vertebrados, el estudio de las CL en \et{vertebrados no mamíferos} es un paso para la integración de la respuesta innata y adaptativa \cite{article:vertebrados}, debido a la disponibilidad, existencia y elevado precio de reactivos e instrumentos el estudio de CL en vertebrados no mamíferos se ve limitado.
